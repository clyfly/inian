...
if [[ $1 = "-b" || $1 = "--build" ]]; then
	...
	if [ -d "$AK3_DIR" ]; then
	...
	elif ! git clone -q https://github.com/clyfly/AnyKernel3; then
        ...
        echo -e "**   Rad Kernel Compiled $((SECONDS / 60)) minute(s) and $((SECONDS % 60)) second(s)!    **"
        echo -e "**                                                        **"
        echo -e "************************************************************"
        echo -e ""
        echo -e ""
